module_notes <- list(
  ...
  hb3_test2 = list("Investment — reference test 2", "RBNZ and Stats NZ series · HM3", "Uses the same HM3 data and selectors as Investment, rendered by the new reference-driven plotting workflow for comparison."),
