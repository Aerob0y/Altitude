server <- function(input, output, session) {
  ...
  mod_hm2_server("hm2_update_main", selected_tab = tab, activate_on = "hm2_update", plot_function = standard_plot, series_guide = guide)
  mod_hm3_server("hm3_update_main", selected_tab = tab, activate_on = "hm3_update", plot_function = standard_plot, series_guide = guide)
  mod_hm4_server("hm4_update_main", selected_tab = tab, activate_on = "hm4_update", plot_function = standard_plot, series_guide = guide)
  mod_hm5_server("hm5_update_main", selected_tab = tab, activate_on = "hm5_update", plot_function = standard_plot, series_guide = guide)
  mod_hm6_server("hm6_update_main", selected_tab = tab, activate_on = "hm6_update", plot_function = standard_plot, series_guide = guide)
  mod_hm7_server("hm7_update_main", selected_tab = tab, activate_on = "hm7_update", plot_function = standard_plot, series_guide = guide)
  mod_hm8_server("hm8_update_main", selected_tab = tab, activate_on = "hm8_update", plot_function = standard_plot, series_guide = guide)
  mod_hm9_server("hm9_update_main", selected_tab = tab, activate_on = "hm9_update", plot_function = standard_plot, series_guide = guide)
  mod_hm10_server("hm10_update_main", selected_tab = tab, activate_on = "hm10_update", plot_function = standard_plot, series_guide = guide)
  mod_hm14_server("hm14_update_main", selected_tab = tab, activate_on = "hm14_update", plot_function = standard_plot, series_guide = guide)
  ...
  output$hm2_update_ui <- renderUI({mod_hm2_ui("hm2_update_main", series_guide = guide)})
  output$hm3_update_ui <- renderUI({mod_hm3_ui("hm3_update_main", series_guide = guide)})
  output$hm4_update_ui <- renderUI({mod_hm4_ui("hm4_update_main", series_guide = guide)})
  output$hm5_update_ui <- renderUI({mod_hm5_ui("hm5_update_main", series_guide = guide)})
  output$hm6_update_ui <- renderUI({mod_hm6_ui("hm6_update_main", series_guide = guide)})
  output$hm7_update_ui <- renderUI({mod_hm7_ui("hm7_update_main", series_guide = guide)})
  output$hm8_update_ui <- renderUI({mod_hm8_ui("hm8_update_main", series_guide = guide)})
  output$hm9_update_ui <- renderUI({mod_hm9_ui("hm9_update_main", series_guide = guide)})
  output$hm10_update_ui <- renderUI({mod_hm10_ui("hm10_update_main", series_guide = guide)})
  output$hm14_update_ui <- renderUI({mod_hm14_ui("hm14_update_main", series_guide = guide)})
  output$hs32_update_ui <- renderUI({mod_hs32_ui("hs32_update_main", series_guide = guide)})
